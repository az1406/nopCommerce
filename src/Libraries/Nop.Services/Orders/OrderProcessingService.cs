...
public partial class OrderProcessingService : IOrderProcessingService
{
    ...
    public virtual bool CanMarkOrderAsPaid(Order order)
    {
        ...
        return NopRuleEngine.StartSession(OrderOperations.Tag, order).Allows(OrderOperation.MarkAsPaid);
    }
    ...
    public virtual async Task<bool> CanPartiallyRefundAsync(Order order, decimal amountToRefund)
    {
        ...
        return NopRuleEngine.StartSession(OrderOperations.Tag, order, new RefundRequest(amountToRefund), paymentMethod).Allows(OrderOperation.PartialRefund);
    }
    ...
    public virtual bool CanVoidOffline(Order order)
    {
        ...
        return NopRuleEngine.StartSession(OrderOperations.Tag, order).Allows(OrderOperation.VoidOffline);
    }
